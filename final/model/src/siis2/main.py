...
#model = siis2.siis2_epidemic(graphml=sys.argv[1])

graph = gt.collection.data["polblogs"]
model = siis2.siis2_epidemic(graph=graph, seed=2)
...
gt.graph_draw(g, pos=pos, vertex_fill_color=v_reinfected[0], output="test_attack1.pdf")
gt.graph_draw(g, pos=pos, vertex_fill_color=v_reinfected[1], output="test_attack2.pdf")
gt.graph_draw(g, pos=pos, vertex_fill_color=v_infected[0], output="test_attack3.pdf")
gt.graph_draw(g, pos=pos, vertex_fill_color=v_infected[1], output="test_attack4.pdf")
